...
public interface IImplementationTypeSelector : IAssemblySelector {
    ...
    IOptionTypeSelector AddOptions();

    IOptionTypeSelector AddOptions(Action<IImplementationTypeFilter> action, bool publicOnly);

    IOptionTypeSelector AddOptionsCurrent();

    IOptionTypeSelector AddOptionsCurrent(Action<IImplementationTypeFilter> action, bool publicOnly);
}
